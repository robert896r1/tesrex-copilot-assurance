...
Start here after the root README.

## Public user/contributor docs

- `docs/code_walkthrough.md` — how the starter-kit code is organized.
- `docs/evidence_contract.md` — evidence pack semantics and status meanings.
- `docs/limitations.md` — what the starter kit can and cannot prove.
...
## Website/sample guidance

For websites or blog posts, link to the committed Markdown sample on GitHub or host a separate sanitized HTML sample. Do not link to `artifacts/`, `localhost`, `127.0.0.1`, or generated local report paths.
